...
// https://www.flaticon.com/free-icon/plus_748113?term=plus&page=1&position=3
class  IconPlus extends Component {
    render() {
        return (
            <svg className={"icon " + (this.props.className? this.props.className:"")} 
                onClick={(e) => {this.props.onClick(e)}}
                version="1.1" x="0px" y="0px" width="93.562px" height="93.562px" viewBox="0 0 93.562 93.562" >
                <g>
